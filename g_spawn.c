...
//ammo_bullets startsolid at (124 -1224 60) in map sickre.bsp new map created sickre_2016

// 1st number higher is to the right lower more to left
// last number higher is up lower is down

vec3_t spawnvecs[]={ {992,1088,-40}, {480,-1824,24}, {-688,-1104,32}, {2536,408,584}, {-224,-544,-40}, {-1960,24,24}, };
		...
		if (ent != g_edicts)
		{
			...
			if (deathmatch->value)
			{
				if (!strcmp(ent->classname,"info_player_deathmatch")) 
				{
					...
					if (!strcmp(level.mapname, "sickre_2016") && VectorCompare(ent->s.origin, spawnvecs[2]))
					{
						ent->s.origin[1] = -1300;
					}
...
// END:		Xatrix/Ridah/Navigator/19-mar-1998
	...
	// KOOGLEBOT_ADD 5/4/2016 added by Ghost
	...
	// KOOGLEBOT_END 5/4/2016 added by Ghost
}
...
void SP_worldspawn (edict_t *ent)
{
	...
	// KOOGLEBOT_ADD
	level.num_spawncounts = 0;      // progressive total
	level.num_team1spawncounts = 0; // progressive total
	level.num_team2spawncounts = 0; // progressive total

	level.num_whoreloads = 0;       // progressive total
	level.num_dogloads = 0;         // progressive total
	level.num_botloads = 0;         // progressive total

	level.num_bitchloads = 0;       // progressive total
	level.num_bumsitloads = 0;      // progressive total
	level.num_mummyloads = 0;       // progressive total
	level.num_punkloads = 0;        // progressive total
	level.num_runtloads = 0;        // progressive total
	level.num_shortyloads = 0;      // progressive total
	level.num_spiderloads = 0;      // progressive total
	level.num_thugloads = 0;        // progressive total
	level.num_thugsitloads = 0;     // progressive total
	level.num_bumloads = 0;         // progressive total

	level.num_cast1spawncounts = 0; // progressive total
	level.num_cast2spawncounts = 0; // progressive total
	level.num_castspawncounts = 0;	// progressive total

	level.num_speakers = 0;         // progressive total
	level.num_rats = 0;             // progressive total

	level.num_railgun = 0;          // progressive total
	level.num_bfg = 0;              // progressive total
	level.num_machinegun = 0;       // progressive total
	level.num_supershotgun = 0;     // progressive total
	level.num_chaingun = 0;         // progressive total
	level.num_hyperblaster = 0;     // progressive total
	level.num_tommygun = 0;         // progressive total
	level.num_heavymachinegun = 0;  // progressive total
	level.num_grenadelauncher = 0;  // progressive total
	level.num_bazooka = 0;          // progressive total
	level.num_flamethrower = 0;     // progressive total
	level.num_crowbar = 0;          // progressive total
	level.num_pistol = 0;           // progressive total
	level.num_shotgun = 0;          // progressive total
	level.num_shard = 0;            // progressive total
	level.num_combatarmor = 0;      // progressive total
	level.num_bodyarmor = 0;        // progressive total

	level.num_combatarmor = 0;      // progressive total
	level.num_bodyarmor = 0;        // progressive total
	level.num_quad = 0;             // progressive total
	level.num_quadfire = 0;         // progressive total
	level.num_invulnerability = 0;  // progressive total
	level.num_armorcombat = 0;      // progressive total
	level.num_armorbody = 0;        // progressive total
	level.num_health_lg = 0;        // progressive total
	level.num_health = 0;           // progressive total

	level.num_health_sm = 0;        // progressive total
	level.num_powershield = 0;      // progressive total
	level.num_bandolier = 0;        // progressive total
	level.num_slugs = 0;            // progressive total
	level.num_cells = 0;            // progressive total

	level.num_grenades = 0;         // progressive total
	level.num_flametank = 0;        // progressive total
	level.num_cylinder = 0;         // progressive total
	level.num_shells = 0;           // progressive total
	level.num_bullets = 0;          // progressive total
	level.num_rockets = 0;          // progressive total
	level.num_308 = 0;              // progressive total
	// KOOGLEBOT_END
...
//	sp_blood1 = gi.modelindex("sprites/blood/blood1.sp2");
	...
	// map count down
	gi.soundindex("bm_mapstart/10_0.wav");
	gi.soundindex("bm_ticks/botload1.wav");
	gi.soundindex("bm_ticks/botload2.wav");
...
//
	...
	if(allow_map_voting && custom_map_filename[0]!=0)
	{
		...
		for (q = 0; q <= 0; q++)
		{
			if (q == 1)
			{
				sprintf(mappic, "pics/%s.pcx", "bloodmoney");
				gi.imageindex(mappic);
			}
			else
				goto logo_download_done;
			break;
