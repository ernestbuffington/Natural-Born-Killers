...
//
//  I got this code from Steve Yeager, but thanks go to the
//  author. he just rewrote it to allow the use of buffers
//  instead of files, someone else wrote the original code.
///////////////////////////////////////////////////////////
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
